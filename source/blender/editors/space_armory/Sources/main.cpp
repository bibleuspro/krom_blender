...
int kore(int argc, char** argv) {
	...
	assetsdir = "/Users/lubos/armory/tropic/build/krom";// argv[1];
	shadersdir = "/Users/lubos/armory/tropic/build/krom-resources";// argv[2];
	kromjs = assetsdir + "/krom.js";
	
	Kore::setFilesLocation("/Users/lubos/armory/tropic/build/krom");//(argv[1]);
